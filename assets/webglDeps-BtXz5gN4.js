import{m as c}from"./ProgramTemplate-CQnB3Mav.js";import{o as h,e as _,a as g,b as y}from"./ProgramTemplate-CQnB3Mav.js";import{R as F,a as v}from"./FramebufferObject-D2pE_7NQ.js";import{dX as P}from"./index-rbwFz4i4.js";import{t as l}from"./NestedMap-C3hRTnZR.js";class d{constructor(e){this._rctx=e,this._store=new l}dispose(){this._store.forAll(e=>e.dispose()),this._store.clear()}acquire(e,t,o,s){const r=this._store.get(e,t);if(r!=null)return r.ref(),r;const n=new c(this._rctx,e,t,o,s);return n.ref(),this._store.set(e,t,n),n}get test(){}}function p(i){const{options:e,value:t}=i;return typeof e[t]=="number"}function $(i){let e="";for(const t in i){const o=i[t];if(typeof o=="boolean")o&&(e+=`#define ${t}
