const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/HUDMaterial.glsl-CtOLFx_c.js","assets/index-Btyj_e22.js","assets/index-1Ols0T8J.css","assets/OutputColorHighlightOID.glsl-BhrI3wMp.js","assets/videoUtils-BqsT1Kqk.js","assets/requestImageUtils-DBfEj-WJ.js","assets/basicInterfaces-CZwQPxTp.js","assets/TextureFormat-1mYWTFa-.js","assets/BufferView-CYbRrMZQ.js","assets/mat4f64-q_b6UJoq.js","assets/Indices-LFDuyM-C.js","assets/triangle-CViB-VLO.js","assets/sphere-BWM9spN1.js","assets/mat3f64-B5o_lm6j.js","assets/vectorStacks-D7GRVTeg.js","assets/quatf64-aQ5IuZRd.js","assets/lineSegment-DHEglvBo.js","assets/VertexAttribute-B3BTnNfN.js","assets/glsl-Cj7KC756.js","assets/BindType-BBwFZqyN.js","assets/ShaderOutput-Bdd80V3g.js","assets/renderState-CUj6RqJo.js","assets/boundedPlane-D6wSQhuV.js","assets/plane-DLQjn7Jn.js","assets/projectVectorToVector-DR1g-LQg.js","assets/projectPointToVector-BK33IwoO.js","assets/frustum-By6vgkJi.js","assets/IntersectorType-gQim6TH1.js","assets/orientedBoundingBox-M3P743N3.js","assets/quat-CAuRaFQ1.js","assets/spatialReferenceEllipsoidUtils-hAdzTDsD.js","assets/computeTranslationToOriginAndRotation-D9omgdEo.js","assets/dehydratedFeatureUtils-BXMEI8JF.js","assets/meshVertexSpaceUtils-CHeQiXId.js","assets/MeshLocalVertexSpace-DXtjzQmS.js","assets/hydratedFeatures-DrQB8grU.js","assets/vec3f32-WCVSSNPR.js","assets/ShaderBuilder-Cpl7q9Oj.js"])))=>i.map(i=>d[i]);
import{og as Se,dW as Re,cr as ut,h2 as Pe,oh as dt,jW as Ae,oi as ft,ie as pt,hX as ht,_ as gt,jy as Fe,k0 as vt,ar as A,mD as Ie,hR as We,fY as le,fW as Y,aP as G,be as xe,fE as Xe,fH as q,kq as pe,oj as ke,aU as Qe,bo as X,fU as oe,fZ as Ze,du as mt,fG as Ee,gm as St,cF as xt,hS as bt,ba as Ct,aR as Ot,ok as $t,bp as Tt}from"./index-Btyj_e22.js";import{i as Pt,L as At,a as Et,m as yt,s as zt,c as Rt,e as Ft,b as It,o as wt,d as we,f as ge,g as _e,h as De,w as _t,t as Dt,j as Mt,k as H,l as jt,q as Lt,r as Nt,u as ee,v as Ut,x as Bt,F as Vt,y as qt,z as Ht,A as Gt,B as Wt,C as E,D as Xt,E as Z,G as kt,H as Ye,I as Je,J as Qt,K as Zt,M as Yt,N as Jt,O as Kt,R as eo,S as to,P as oo,Q as io,T as Me,U as je,V as ao,W as so,X as Le}from"./OutputColorHighlightOID.glsl-BhrI3wMp.js";import{e as Ke}from"./mat3f64-B5o_lm6j.js";import{e as ro}from"./mat4f64-q_b6UJoq.js";import{s as no,g as lo,o as Ne,f as co,y as uo,T as Ue}from"./BufferView-CYbRrMZQ.js";import{O as fo}from"./InterleavedLayout-C_iHOV72.js";import{n as U,u as et,w as ve}from"./ShaderOutput-Bdd80V3g.js";import{l as tt,u as po,n as ho,t as go,d as vo}from"./dehydratedFeatureUtils-BXMEI8JF.js";import{e as u}from"./VertexAttribute-B3BTnNfN.js";import{n as d,t as z}from"./glsl-Cj7KC756.js";import{a as mo}from"./BindType-BBwFZqyN.js";import{i as So}from"./ShaderBuilder-Cpl7q9Oj.js";import{B as xo,o as bo,g as Co,p as Oo}from"./renderState-CUj6RqJo.js";let $o=class extends Pt{constructor(e,t,i){super(e,"vec4",mo.Draw,(a,s,r)=>a.setUniform4fv(e,t(s,r),i))}};const ye=128,Q=.5,fi=Se(Q/2,Q/2,1-Q/2,1-Q/2);function pi(o){return o==="cross"||o==="x"}function hi(o,e=ye,t=e*Q,i=0){const{data:a,parameters:s}=To(o,e,t,i);return new At(a,s)}function To(o,e=ye,t=e*Q,i=0){return{data:Po(o,e,t,i),parameters:{mipmap:!1,wrap:{s:Re.CLAMP_TO_EDGE,t:Re.CLAMP_TO_EDGE},width:e,height:e,components:4,noUnpackFlip:!0,reloadable:!0}}}function Po(o,e=ye,t=e*Q,i=0){switch(o){case"circle":default:return Ao(e,t);case"square":return Eo(e,t);case"cross":return zo(e,t,i);case"x":return Ro(e,t,i);case"kite":return yo(e,t);case"triangle":return Fo(e,t);case"arrow":return Io(e,t)}}function Ao(o,e){const t=o/2-.5;return ae(o,at(t,t,e/2))}function Eo(o,e){return ot(o,e,!1)}function yo(o,e){return ot(o,e,!0)}function zo(o,e,t=0){return it(o,e,!1,t)}function Ro(o,e,t=0){return it(o,e,!0,t)}function Fo(o,e){return ae(o,st(o/2,e,e/2))}function Io(o,e){const t=e,i=e/2,a=o/2,s=.8*t,r=at(a,(o-e)/2-s,Math.sqrt(s*s+i*i)),l=st(a,t,i);return ae(o,(c,n)=>Math.max(l(c,n),-r(c,n)))}function ot(o,e,t){return t&&(e/=Math.SQRT2),ae(o,(i,a)=>{let s=i-.5*o+.25,r=.5*o-a-.75;if(t){const l=(s+r)/Math.SQRT2;r=(r-s)/Math.SQRT2,s=l}return Math.max(Math.abs(s),Math.abs(r))-.5*e})}function it(o,e,t,i=0){e-=i,t&&(e*=Math.SQRT2);const a=.5*e;return ae(o,(s,r)=>{let l,c=s-.5*o,n=.5*o-r-1;if(t){const S=(c+n)/Math.SQRT2;n=(n-c)/Math.SQRT2,c=S}return c=Math.abs(c),n=Math.abs(n),l=c>n?c>a?Math.sqrt((c-a)*(c-a)+n*n):n:n>a?Math.sqrt(c*c+(n-a)*(n-a)):c,l-=i/2,l})}function at(o,e,t){return(i,a)=>{const s=i-o,r=a-e;return Math.sqrt(s*s+r*r)-t}}function st(o,e,t){const i=Math.sqrt(e*e+t*t);return(a,s)=>{const r=Math.abs(a-o)-t,l=s-o+e/2+.75,c=(e*r+t*l)/i,n=-l;return Math.max(c,n)}}function ae(o,e){const t=new Uint8Array(4*o*o);for(let i=0;i<o;i++)for(let a=0;a<o;a++){const s=a+o*i;let r=e(a,i);r=r/o+.5,ut(r,t,4*s)}return t}function wo(o){return o instanceof Float32Array&&o.length>=16}function _o(o){return Array.isArray(o)&&o.length>=16}function Do(o){return wo(o)||_o(o)}class Mo{constructor(){this.factor=new Be,this.factorAlignment=new Be}}class Be{constructor(){this.scale=0,this.factor=0,this.minScaleFactor=0}}function jo(o,e){const{vertex:t,fragment:i}=o;o.include(Et,e),t.include(tt),t.main.add(d`vec4 posProjCenter;
